<?php 
 ...
 if(empty($uniqueID))
  {//not valid page with relative links
    ?>
    <!DOCTYPE html>
<html lang="en">
<head>
...
<script>
  (function() {
    var cx = '016656741306535874023:2ffbgtaphhe';
...
<div class="j-header">
  <div class="name">
    <h1>Advances in Renewable Energy (ARE)<!-- <br><p class="body">ISSN: 1929-2732</p> --></h1>
    <div class="oalink">
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <h2>Uh Oh!</h2>
      <p class="body">The page you have requested cannot be found</p>

      <p class="body">You are requesting a page that does not exist. Please make sure that the page you are visiting is valid and that you have no misepelled the URL.</p>

      <p class="body">If the issue is not solved, please use the <script>var refURL = window.location.protocol + "//" + window.location.host + window.location.pathname; document.write('<a href="http://international-aset.com/feedback/?refURL=' + refURL+'" class="body-link">Feedback Form</a>');</script> to report a problem.</p>
  ...
  else 
  {
    while($row = mysql_fetch_array($result))
    {
      if($uniqueID == $row['uniqueID']){
        $query = "UPDATE users SET confirmed = 1 WHERE uniqueID = '$uniqueID'";
        mysql_query($query);
        //valid id passed. confirmed = 1;
        ?>
          <!DOCTYPE html>
<html lang="en">
<head>
...
<meta name="description" content="{{page.meta}}">
<meta name="keywords" content="{{page.keyword}}">
<title>ARE - Subscription Confirmed</title>
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <h2>Subscription Confirmed</h2>
      <p class="body">Thank you for confirming your registration. You will now receive regular updates.</p>
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    <div class="unit unit-s-1 unit-m-1 unit-l-1">
    <h2>Invalid User</h2>
      <p class="body">There has been a problem confirming your subscription. Please contact the webmaster using the <script>var refURL = window.location.protocol + "//" + window.location.host + window.location.pathname; document.write('<a href="http://international-aset.com/feedback/?refURL=' + refURL+'" class="body-link">Feedback Form</a>');</script>. Thank you. </p>
