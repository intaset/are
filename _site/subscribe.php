...
<title>ARE - Email Confirmed</title>
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <p class="body">Thank you for confirming your subscription to ARE. You will now receive regular updates about this journal.</p>
  ...
  <div class="unit unit-s-1 unit-s-1-3 unit-m-1-3 unit-l-1-3">
    <div class="unit-spacer">
      <ul class="footer-links">
        ...
        <li><a href="http://avestia.com/sitemap" class="body-link">Sitemap</a></li>
      </ul>
    </div>
  </div>
