...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <h2>Email Already Registered</h2>
      <p class="body">Your email is already registered to receive updates for this journal. Thank you.</p>
...
<meta name="description" content="{{page.meta}}">
<meta name="keywords" content="{{page.keyword}}">
<title>ARE - Confirm Subscription</title>
...
<div class="desktop jhead">
  ...
  <div class="main-content j-home">
    ...
    <h2>Confirm Subscription</h2>
      <p class="body">Thank you for subscribing to receive regular updates for this journal. A confirmation email has been sent to your email. Please click on the confirmation link available in the email to confirm your subscription.</p>
...
<?php 
  ...
  //not valid page - no argument passed?>
    <!DOCTYPE html>
<html lang="en">
<head>
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
